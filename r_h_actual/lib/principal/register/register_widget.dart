...
class _RegisterWidgetState extends State<RegisterWidget>
  ...
  void initState() {
    ...
    _model.txtConfPasswordTextController ??= TextEditingController();
    _model.txtConfPasswordFocusNode ??= FocusNode();
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.txtConfPasswordTextController,
                                focusNode: _model.txtConfPasswordFocusNode,
                                obscureText: !_model.txtConfPasswordVisibility,
                                decoration: InputDecoration(
                                  ...
                                  suffixIcon: InkWell(
                                    onTap: () => setState(
                                      () => _model.txtConfPasswordVisibility =
                                          !_model.txtConfPasswordVisibility,
                                    ),
                                    focusNode: FocusNode(skipTraversal: true),
                                    child: Icon(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FlutterFlowRadioButton(
                                      options: ['Activo', 'Inactivo'].toList(),
                                      onChanged: (val) => setState(() {}),
                                      controller: _model
                                              .radioButtonValueController1 ??=
                                          FormFieldController<String>('Activo'),
                                      optionHeight: 32.0,
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.txtPasswordTextController.text !=
                                    _model.txtConfPasswordTextController.text) {
                                ...
                                await EmpleadosRecord.collection
                                    ...
                                    .update(createEmpleadosRecordData(
                                      ...
                                      password:
                                          _model.txtPasswordTextController.text,
                                      estado: _model.radioButtonValue1,
                                      colaborador: _model.radioButtonValue2 ==
                                          'Colaborador',
                                      jefatura: _model.radioButtonValue2 ==
                                          'Jefatura',
                                    ));
