...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFCBDDD1);
  late Color secondary = const Color(0xFF7D9B76);
  late Color tertiary = const Color(0xFFF6F6E9);
  late Color alternate = const Color(0xFF272727);
  late Color primaryText = const Color(0xFF1A1F24);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0x9AFFFFFF);
