...
import 'beneficios_admin_model.dart';
export 'beneficios_admin_model.dart';

class BeneficiosAdminWidget extends StatefulWidget {
  const BeneficiosAdminWidget({super.key});

  @override
  State<BeneficiosAdminWidget> createState() => _BeneficiosAdminWidgetState();
}

class _BeneficiosAdminWidgetState extends State<BeneficiosAdminWidget>
    with TickerProviderStateMixin {
  late BeneficiosAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BeneficiosAdminModel());
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (valueOrDefault<bool>(
                            currentUserDocument?.jefatura, false))
                          Padding(
                                                    ...
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        if (confirmDialogResponse) {
                                                          await listViewBeneficiosRecord
                                                              .reference
                                                              .delete();
