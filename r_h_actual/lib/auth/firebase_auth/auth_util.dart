...
DocumentReference? get currentUserReference =>
    loggedIn ? EmpleadosRecord.collection.doc(currentUser!.uid) : null;

EmpleadosRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : EmpleadosRecord.getDocument(EmpleadosRecord.collection.doc(uid))
              .handleError((_) {}),
    )
