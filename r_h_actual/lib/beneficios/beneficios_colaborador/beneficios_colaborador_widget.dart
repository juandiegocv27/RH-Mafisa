...
import 'beneficios_colaborador_model.dart';
export 'beneficios_colaborador_model.dart';

class BeneficiosColaboradorWidget extends StatefulWidget {
  const BeneficiosColaboradorWidget({super.key});

  @override
  State<BeneficiosColaboradorWidget> createState() =>
      _BeneficiosColaboradorWidgetState();
}

class _BeneficiosColaboradorWidgetState
    extends State<BeneficiosColaboradorWidget> with TickerProviderStateMixin {
  late BeneficiosColaboradorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BeneficiosColaboradorModel());
